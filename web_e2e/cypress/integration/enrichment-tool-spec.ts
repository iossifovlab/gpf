...
describe('Enrichment tool tests', () => {
  ...
  it('should display enrichment models block', () => {
    enrichmenToolPage.navigateToDatasetPage(datasetIds.iossifov2014, toolPageNames.enrichmentTool);
    enrichmenToolPage.enrichmentModelsBlock.should('be.visible');
  });

  it('should display \'Enrichment Test\' button', () => {
    enrichmenToolPage.navigateToDatasetPage(datasetIds.iossifov2014, toolPageNames.enrichmentTool);
    enrichmenToolPage.enrichmentTestButton.should('be.visible');
  });
