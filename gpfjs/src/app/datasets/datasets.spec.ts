...
import { Column, ColumnGroup, Dataset, GeneBrowser, GenotypeBrowser, PersonFilter, PersonSetCollection, PersonSetCollections } from "./datasets";
...
describe('GenotypeBrowser', () => {
  it('should create genotype browser from json', () => {
    const genotypeMock1 = new GenotypeBrowser(
      ...
      false,
      true,
      [new Column('name1', 'source1', 'format1'), new Column('name2', 'source2', 'format2')],
      [
...
describe('Dataset', () => {
  it('should create dataset from json', () => {
    const datasetMock1 = new Dataset(
      'id1', 'desc1', 'name1', ['parent1', 'parent2'], false, ['study1', 'study2'], ['studyName1', 'studyName2'],
      ['studyType1', 'studyType2'], 'phenotypeData1', false, true, true, false, ['1', '2', false],
      new GenotypeBrowser(false, true, false, false, true, false, true, false, false, true,
        [new Column('name1', 'source1', 'format1'), new Column('name2', 'source2', 'format2')],
        [
          new PersonFilter('personFilter1', 'string1', 'source1', 'sourceType1', 'filterType1', 'role1'),
          new PersonFilter('personFilter2', 'string2', 'source2', 'sourceType2', 'filterType2', 'role2')
        ...
        new Set(['inheritance', 'string1']), new Set(['selectedInheritance', 'string2']),
        new Set(['variant', 'string3']), new Set(['selectedVariant', 'string1']), 5),
      new PersonSetCollections([
        ...
        true, 'frequencyCol1', 'frequencyName1', 'effectCol1', 'locationCol1', 5, 6), false, 'genome1'
    );

    const datasetMock2 = Dataset.fromJson({
      id: 'id1',
      description: 'desc1',
      name: 'name1',
    ...
    expect(datasetMock1).toEqual(datasetMock2);
  });
  ...
  it('should create dataset from dataset and details json\'s', () => {
    ...
    const datasetMock2 = Dataset.fromDatasetAndDetailsJson({
      id: 'id1',
      description: 'desc1',
      name: 'name1',
      parents: ['parent1', 'parent2'],
  ...
  it('should create dataset from json array', () => {
    ...
    new Dataset(
      'id2', 'desc2', 'name2', ['parent2', 'parent2'], true, ['study2', 'study2'], ['studyName2', 'studyName2'],
      ['studyType2', 'studyType2'], 'phenotypeData2', true, false, true, true, ['2', '3', true],
      new GenotypeBrowser(true, false, true, false, false, false, true, false, false, true,
        [new Column('name2', 'source12', 'format2'), new Column('name4', 'source2', 'format3')],
        [
        ...
        new Set(['inheritance1', 'string2']), new Set(['selectedInheritance3', 'string5']),
        new Set(['variant2', 'string5']), new Set(['selectedVariant1', 'string3']), 6),
      new PersonSetCollections([
        new PersonSetCollection('id4', 'name4', 'id4',
        new PersonSet('id4', 'name1', ['value1', 'value2'], 'color1'),
        [
          new PersonSet('id4', 'name2', ['value2', 'value2'], 'color3'),
          new PersonSet('id2', 'name3', ['value2', 'value3'], 'color4')
        ]),
        new PersonSetCollection('id2', 'name3', 'id2',
        ...
        false, 'frequencyCol6', 'frequencyName7', 'effectCol4', 'locationCol2', 7, 8), true, 'genome2'
    )
    ];

    const datasetMock2 = Dataset.fromJsonArray([
      {
        id: 'id1',
        description: 'desc1',
        name: 'name1',
