...
describe('GeneSets', () => {
    it('should test GeneSetsCollection from JSON method', () => {
    ...
    it('should test GeneSetsCollection from JSON array method', () => {
        const geneSetsCollectionMock1 = [
            ...
            new GeneSetsCollection('name15', 'desc16', [
                new GeneSetType('datasetId17', 'datasetName18', 'personSetCollectionId19', 'personSetCollectionName20', ['personSetCollectionLegend21', 'personSetCollectionLegend22']),
                new GeneSetType('datasetId23', 'datasetName24', 'personSetCollectionId25', 'personSetCollectionName26', ['personSetCollectionLegend27', 'personSetCollectionLegend28'])
            ])
        ];
        ...
        const geneSetsCollectionFromJSONArray1 = GeneSetsCollection.fromJsonArray([
            ...
            },
            {
                ...
                'types': [
                    {
                        'datasetId': 'datasetId17', 'datasetName': 'datasetName18', 'personSetCollectionId': 'personSetCollectionId19', 'personSetCollectionName': 'personSetCollectionName20',
                        'personSetCollectionLegend': [ 'personSetCollectionLegend21', 'personSetCollectionLegend22' ] 
                    }, {
                        'datasetId': 'datasetId23', 'datasetName':'datasetName24', 'personSetCollectionId':'personSetCollectionId25', 'personSetCollectionName': 'personSetCollectionName26', 
    ...
    it('should test GeneSet from JSON method', () => {
    ...
    it('should test GeneSet from JSON method array', () => {
    ...
    it('should test GeneSetType', () => {
        const geneSetTypeMock1 = new GeneSetType('datasetId1', 'datasetName2', 'personSetCollectionId3', 'personSetCollectionName4', [
            'personSetCollectionLegend5', 'personSetCollectionLegend6'
        ]);

        const geneSetTypeMockFromJSON1 = GeneSetType.fromJson({
            'datasetId': 'datasetId1', 'datasetName': 'datasetName2', 'personSetCollectionId': 'personSetCollectionId3', 'personSetCollectionName': 'personSetCollectionName4',
            'personSetCollectionLegend': [ 'personSetCollectionLegend5', 'personSetCollectionLegend6' ] 
        });
    });

    it('should test GeneSetType from JSON array', () => {
        const geneSetTypeMock1 = [
        ...
        const geneSetTypeMockFromJSON1 = GeneSetType.fromJsonArray([
            {
                'datasetId': 'datasetId1', 'datasetName': 'datasetName2', 'personSetCollectionId': 'personSetCollectionId3', 'personSetCollectionName': 'personSetCollectionName4',
                'personSetCollectionLegend': [ 'personSetCollectionLegend5', 'personSetCollectionLegend6' ] 
            },
            {
                'datasetId': 'datasetId7', 'datasetName': 'datasetName8', 'personSetCollectionId': 'personSetCollectionId9', 'personSetCollectionName': 'personSetCollectionName10',
