...
./build.sh preset:"$preset" clobber:"$clobber" expose_ports:"$expose_ports" stage:"Tests - dae"
./build.sh preset:"$preset" clobber:"$clobber" expose_ports:"$expose_ports" stage:"Tests - wdae"
