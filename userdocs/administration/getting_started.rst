...
The GPF simple pheno import tool prepares phenotype data to be use by GPF
system.
...
When ready with changes in the annotation configuration file ``annotation.conf`` 
we need to rerun import process. Let's do it of ``iossifov_2014`` data:
