...
class GenotypeBrowserQueryView(QueryBaseView, DatasetAccessRightsView):
    ...
    def post(
        ...
        result = dataset.query_variants_preview_wdae(
            data,
...
class GenotypeBrowserQueryDownloadView(QueryBaseView, DatasetAccessRightsView):
    """Genotype browser queries view."""
    ...
    def post(
        ...
        result = dataset.query_variants_download_wdae(
            data,
            self.query_transformer,
            self.response_transformer,
            max_variants_count=max_variants,
