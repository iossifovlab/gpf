...
def get_wdae_dataset(
    dataset: Union[Dataset, GenotypeData, str]
) -> Optional[Dataset]:
    """
...
def get_genotype_data(
    ...
    return cast(GenotypeData, gpf_instance.get_genotype_data(dataset_id))
...
def get_wdae_children(dataset: Dataset) -> List[Dataset]:
    """
