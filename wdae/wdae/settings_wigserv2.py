...
ALLOWED_HOSTS = ['seqpipe-vm.setelis.com', 'seqpipe.setelis.com', 'wigserv2', 'wigserv2.cshl.edu']
...
MEDIA_URL = 'http://wigserv2.cshl.edu/dae-media/'
...
STATIC_URL = 'http://wigserv2.cshl.edu/dae-static/'
