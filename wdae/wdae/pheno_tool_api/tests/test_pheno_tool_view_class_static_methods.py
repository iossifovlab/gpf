...
#     }
#     result = PhenoResult()
#     result._set_positive_stats(1, 2, 3)
#     result._set_negative_stats(4, 5, 6)
#     result.pvalue = 7
...
# def test_pheno_tool_view_calc_by_effect():
#     class MockPhenoTool:
#         def calc(self, people_variants, sex_split):
#             pr_m = PhenoResult()
#             pr_m._set_positive_stats(1, 2, 3)
#             pr_f = PhenoResult()
#             pr_f._set_positive_stats(4, 5, 6)
