...
class QueryTransformer:
    ...
    def transform_kwargs(self, **kwargs: Any) -> dict[str, Any]:
        ...
        if "personMeasureHistograms" in kwargs:
            person_filters = kwargs.pop("personMeasureHistograms")
            if person_filters:
        ...
        if "familyMeasureHistograms" in kwargs:
            family_filters = kwargs.pop("familyMeasureHistograms")
            if family_filters:
