...
./build.sh preset:"$preset" clobber:"$clobber" expose_ports:"$expose_ports" stage:"Get GPF source"
./build.sh preset:"$preset" clobber:"$clobber" expose_ports:"$expose_ports" stage:"Get GPF data instance"
./build.sh preset:"$preset" clobber:"$clobber" expose_ports:"$expose_ports" stage:"Build documentation"
