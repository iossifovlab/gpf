...
./build.sh preset:"$preset" clobber:"$clobber" expose_ports:"$expose_ports" stage:"Run impala"
./build.sh preset:"$preset" clobber:"$clobber" expose_ports:"$expose_ports" stage:"Prepare GPF data"
./build.sh preset:"$preset" clobber:"$clobber" expose_ports:"$expose_ports" stage:"Prepare GPF remote"
./build.sh preset:"$preset" clobber:"$clobber" expose_ports:"$expose_ports" stage:"Import GPF remote data"
./build.sh preset:"$preset" clobber:"$clobber" expose_ports:"$expose_ports" stage:"Import test data to impala"
