...
./build.sh preset:"$preset" clobber:"$clobber" expose_ports:"$expose_ports" stage:"Prepare GPF remote data"
./build.sh preset:"$preset" clobber:"$clobber" expose_ports:"$expose_ports" stage:"Run cluster"
