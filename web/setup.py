...
setuptools.setup(
    ...
    packages=setuptools.find_namespace_packages(
        where="gpf_web/", exclude=[
            "*.tests", "*.tests.*", "docs"],
    ),
    package_dir={"": "gpf_web"},
    package_data=_expand_recursive_globs("gpf_web", {
        "gpfjs": [
            "static/**/*",
            "templates/**/*",
        ],
    ...
    entry_points={
        "console_scripts": [
            "wgpf=gpf_web.wgpf:cli",
            "wdaemanage=gpf_web.wdaemanage:main",
            "wdaemanage.py=gpf_web.wdaemanage:main",
        ],
    },
    classifiers=[
