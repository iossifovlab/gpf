...
3. Configure the resource `hg38/scores/score9`. To this end create
   ...
   configuration:
    ...
    scores:
      ...
      ## score9
        TODO
    ```
#### Add resource under version control

1. Add large resource files under version control:
...
2. Add the configuration under version control:
