...
Values are either not present (spares matrix) represented as an empty string in the excell or string
...
Values are either not present (sparse matrix) represented as an empty string in the excel or string
...
dt.get_value(family,variable);
returns the value of variable in family if the value present otherwise throws and excpetion
...
class TableInterfaceH5(TableInterface):
    ...
    def load(self, filename):
        ...
        for variableName in self.h5file.variables.keys():
            ...
            self.md[variableName] = {'name':variable.name,'datatype':variable.dataType,'values':variable.values,'uniqueValues':variable.uniqueValues,
                                     'members':variable.members, 'source':variable.source}
