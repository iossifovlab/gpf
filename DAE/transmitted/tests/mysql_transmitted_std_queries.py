...
def dae_query_q201():
    ...
    res = [v for v in tvs]
    print("dae_query_q201: {}".format(len(res)))
    return res
...
def mysql_query_q201(limit=None):
    ...
    res = [v for v in tvs]
    print("mysql_query_q201: {}".format(len(res)))
    return res
...
def dae_query_q301():
    ...
    res = [v for v in tvs]
    print("dae_query_q301: {}".format(len(res)))
    return res
...
def mysql_query_q301(limit=None):
    ...
    res = [v for v in tvs]
    print("mysql_query_q301: {}".format(len(res)))
    return res
...
def dae_query_q401():
    ...
    res = [v for v in tvs]
    print("dae_query_q401: {}".format(len(res)))
    return res
...
def dae_query_q501():
    ...
    res = [v for v in tvs]
    print("dae_query_q501: {}".format(len(res)))
    return res


def mysql_query_q501(limit=None):
    gene_syms = get_gene_set_syms('main', 'FMRP Tuschl')
    assert gene_syms
...
def dae_query_q601():
    ...
    res = [v for v in tvs]
    print("dae_query_q601: {}".format(len(res)))

    return res


def mysql_query_q601(limit=None):
    transmitted_study = vDB.get_study("w1202s766e611")
    ...
    res = [v for v in tvs]
    print("mysql_query_q601: {}".format(len(res)))
    return res


def mysql_query_q701(limit=None):
    ...
    tvs = m.get_transmitted_variants(
        ...
        limit=limit)
    res = [v for v in tvs]
    print("mysql_query_q701: {}".format(len(res)))
    return res


def mysql_query_q702(limit=None):
    effectTypes = ['splice-site', 'nonsense', 'missense', 'frame-shift']
    familyIds = ['14174', ]
    transmitted_study = vDB.get_study("w1202s766e611")
...
def mysql_query_q801(limit=None):
    effectTypes = ['splice-site', 'nonsense', 'missense', 'frame-shift']
    transmitted_study = vDB.get_study("w1202s766e611")
    ...
    tvs = m.get_transmitted_variants(
        ...
        limit=limit)
    res = [v for v in tvs]
    print("mysql_query_q801: {}".format(len(res)))
    return res
