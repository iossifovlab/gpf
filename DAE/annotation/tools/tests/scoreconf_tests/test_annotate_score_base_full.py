...
@pytest.fixture
def input_():
    return [['1', '4', '4372372973', '4372372973', 'sub(A->C)'],
...
@pytest.fixture
def scores():
    score_ = ('1\t4\t4372372973\t4372372973\t0.56789\t-0.56789\n'
...
def annotator(config, scores):
    ...
    return ScoreAnnotator(opts, header=['id', 'chrom', 'pos', 'ending_pos', 'variation'])


def test_base_full(annotator, input_, expected_annotations):
