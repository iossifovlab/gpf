...
def printFamInfo( fInfo, pInfo, out=sys.stdout ):
   flag = False
   for k, v in fInfo.items():
...
if __name__ == "__main__":
   usage = "usage: %prog [options] <INPUT:ped file> <OUTPUT:nuc file>"
   ...
   printFamInfo( fInfo, pInfo, out=fout )
   fout.close()
