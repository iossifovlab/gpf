...
from variants.summary_variant import SummaryVariantFull
from variants.family_variant import FamilyVariantFull
...
def test_family_variants_full(nvcf19f):
    ...
    for index, row in enumerate(nvcf19f.annot_df.to_dict(orient='records')):
        ...
        summary_variant = SummaryVariantFull.from_annot_df(row)
