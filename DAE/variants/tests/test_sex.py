...
def test_query_sexes_male_only(ustudy_single):
...
def test_query_sexes_male_only_eq(ustudy_single):
...
def test_query_sexes_female_only(ustudy_single):
    vs = ustudy_single.query_variants(sexes='female and not male')
    vl = list(vs)
...
def test_query_sexes_female_only_eq(ustudy_single):
    vs = ustudy_single.query_variants(sexes='eq(female)')
    vl = list(vs)
...
def test_query_sexes_single_sex_only(ustudy_single):
