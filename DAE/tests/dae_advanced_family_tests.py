...
class AdvancedFamilyFilterTests(unittest.TestCase):
    ...
    def __family_verbal_iq_count(self, data):
    ...
    def test_family_verbal_iq(self):
      ...
      count = self.__family_verbal_iq_count(self.TEST_DATA_9_1)
      self.assertNotEqual(0, count)

      # Testing the familyVerbalIqLo filter compared to base data
      self.TEST_DATA_9_2['familyVerbalIqLo'] = 23;
      count_with_iq_lo = self.__family_verbal_iq_count(self.TEST_DATA_9_2)
      ...
      count_with_iq_hi = self.__family_verbal_iq_count(self.TEST_DATA_9_2)
      ...
      count_with_iq_lo_wrong = self.__family_verbal_iq_count(self.TEST_DATA_9_2)
      ...
      self.TEST_DATA_9_2['familyVerbalIqLo'] = ''
      count_with_iq_hi_wrong = self.__family_verbal_iq_count(self.TEST_DATA_9_2)
