...
class GenotypeHelper(object):
    ...
    @staticmethod
    def from_studies(denovo_studies, in_child, effect_types):
        return StudiesGenotypeHelper(denovo_studies, in_child, effect_types)
...
class StudiesGenotypeHelper(GenotypeHelper):
    ...
    def __init__(self, denovo_studies, in_child, effect_types):
