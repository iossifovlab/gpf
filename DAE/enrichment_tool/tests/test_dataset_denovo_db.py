...
def test_enrichment_tool_gene_events(denovo_db,
    ...
    assert 170 == len(er['all'].events)
    assert 25 == len(er['rec'].events)
    assert 0 == len(er['male'].events)
    assert 0 == len(er['female'].events)
    assert 170 == len(er['unspecified'].events)
...
def test_enrichment_tool_events(denovo_db,
    ...
    assert 259 == len(er['all'].events)
    assert 25 == len(er['rec'].events)
    assert 0 == len(er['male'].events)
    assert 0 == len(er['female'].events)
    assert 259 == len(er['unspecified'].events)
