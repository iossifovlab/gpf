...
from dae.gene.gene_weight_config import GeneWeightConfig
from dae.gene.gene_term_config import GeneTermConfig
from dae.gene.chromosome_config import ChromosomeConfig
