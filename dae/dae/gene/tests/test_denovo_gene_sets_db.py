...
def test_get_f4_descriptions(denovo_gene_sets_db):
    ...
    assert gene_set_descriptions["types"][0]["personSetCollectionId"] == "phenotype"
    assert gene_set_descriptions["types"][0]["personSetCollectionName"] == "Phenotype"
    assert len(gene_set_descriptions["types"][0]["personSetCollectionLegend"]) == 2
