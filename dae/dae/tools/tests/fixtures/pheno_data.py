...
def populate_instruments():
    ...
    for instrument_name in INSTRUMENT_NAMES:
        ...
        measures_df = pd.DataFrame(MEASURES[instrument_name],
...
MEASURE_COLUMNS = ['measure_name', 'measure_id', 'measure_type',
                   'instrument_name', 'description', 'default_filter',
                   'values_domain', 'min_value', 'max_value']

i1_measures = [['m1', 'i1.m1', MeasureType.continuous, 'i1', '', '', '', 0, 5],
               ['m2', 'i1.m2', MeasureType.categorical, 'i1', '', '', '',
                'sad', 'happy']]
i2_measures = [['m3', 'i2.m3', MeasureType.ordinal, 'i2', '', '', '', 0, 0],
               ['m4', 'i2.m4', MeasureType.ordinal, 'i2', '', '', '', 0, 0],
               ['m5', 'i2.m5', MeasureType.ordinal, 'i2', '', '', '', 0, 100]]
i3_measures = [['m6', 'i3.m6', MeasureType.raw, 'i3', '', '', '', '.', '..'],
               ['m1', 'i3.m1', MeasureType.raw, 'i3', '', '', '', 0, 5]]

MEASURES = {'i1': i1_measures, 'i2': i2_measures, 'i3': i3_measures}

MEASURE_ROWS = {m[1]: [DB, m[1], m[0], m[3], m[2].name, str(m[-2]), str(m[-1])]
