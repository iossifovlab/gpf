...
def test_synonymous_complex_var(default_genome, default_gene_models):
    [effect] = VariantAnnotator.annotate_variant(
        default_gene_models, default_genome, loc='1:897349',
        var='complex(GG->AA)'
    )
...
def test_just_next_to_splice_site_var(default_genome, default_gene_models):
    effects = VariantAnnotator.annotate_variant(
        default_gene_models, default_genome, loc='5:86705101', var='del(4)'
    )
...
def test_chr2_32853362_ins_var(default_genome, default_gene_models):
    effects = VariantAnnotator.annotate_variant(
        default_gene_models, default_genome, loc='6:157527729',
...
def test_chr5_75902128_sub_var(default_genome, default_gene_models):
    [effect] = VariantAnnotator.annotate_variant(
        default_gene_models, default_genome, loc='5:75902128', var='sub(C->T)'
    )
