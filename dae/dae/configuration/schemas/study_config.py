...
family_schema = {
    ...
    "params": {
        "type": "dict",
        "schema": {
            "ped-family": {"type": "string"},
            "ped-person": {"type": "string"},
            "ped-mom": {"type": "string"},
            "ped-dad": {"type": "string"},
            "ped-sex": {"type": "string"},
            "ped-status": {"type": "string"},
            "ped-role": {"type": "string"},
            "ped-no-role": {"type": "string"},
            "ped-proband": {"type": "string"},
            "ped-no-header": {"type": "string"},
            "ped-file-format": {"type": "string"},
            "ped-layout-mode": {"type": "string"},
            "ped-sep": {"type": "string"},
        },
        "default": {},
    },
...
variants_file = {
    ...
    "params": {
        "type": "dict",
        "schema": {
            "add-chrom-prefix": {"type": "string"},
            "del-chrom-prefix": {"type": "string"},
            "dae-include-reference-genotypes": {"type": "boolean"},
