...
from dae.annotation.tools.file_io_tsv import handle_chrom_prefix

if parquet_enabled:
    from dae.annotation.tools.file_io_parquet import ParquetWriter
...
def test_column_coercion():
    ...
    assert ParquetWriter.coerce_column("col1", col1, str) == list(
        map(str, col1)
    )
    assert ParquetWriter.coerce_column("col4", col4, float) == list(
        map(recursive_coerce, col4)
    )


@pytest.mark.parametrize(
    "filename",
    ["fixtures/input3.tsv.gz", "fixtures/input3_no_tabix_header.tsv.gz"],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("fixtures/input4.tsv.gz", False, "2:20001-20004", 4, "2:20001-20004"),
        (
            "fixtures/input4.tsv.gz",
            False,
            "chr2:20001-20004",
            4,
            "2:20001-20004",
        ...
        ("fixtures/input4.tsv.gz", False, "3:10000-20004", 5, "3:10000-20004"),
        (
            "fixtures/input4.tsv.gz",
            False,
            "chr3:10000-20004",
