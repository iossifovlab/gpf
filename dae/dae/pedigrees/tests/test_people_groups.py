    ...
    return GPFConfigParser._dict_to_namedtuple(
        {
            ...
            "domain": {
                "a": {"id": "a", "name": "a", "color": "#e35252",},
                "b": {"id": "b", "name": "b", "color": "#b8008a",},
                "c": {"id": "c", "name": "c", "color": "#a8008a",},
            },
            "default": {
                "id": "unknown",
                "name": "unknown",
    ...
    return GPFConfigParser._dict_to_namedtuple(
        {
            "name": "Role",
            "domain": {
                "prb": {"id": "prb", "name": "prb", "color": "#e35252",},
                "sib": {"id": "sib", "name": "sib", "color": "#b8008a",},
                "mom": {"id": "mom", "name": "mom", "color": "#a8008a",},
                "dad": {"id": "dad", "name": "dad", "color": "#a8008a",},
            },
            "default": {
                "id": "unknown",
                "name": "unknown",
...
def test_family_groups1(people_group_config1, fixture_dirname):
...
def test_family_groups2(people_group_config2, fixture_dirname):
    filename = fixture_dirname("pedigrees/pedigree_phenos.ped")
    assert os.path.exists(filename)
...
def test_family_groups2_unknown(people_group_config2, fixture_dirname):
    filename = fixture_dirname("pedigrees/pedigree_phenos_B.ped")
    assert os.path.exists(filename)
...
def test_family_role_group(people_group_role, fixture_dirname):
    filename = fixture_dirname("pedigrees/pedigree_phenos.ped")
    assert os.path.exists(filename)
...
def test_family_role_group_predefined(fixture_dirname):
    filename = fixture_dirname("pedigrees/pedigree_phenos.ped")
    assert os.path.exists(filename)
...
def test_family_status_group(people_group_status, fixture_dirname):
    filename = fixture_dirname("pedigrees/pedigree_phenos.ped")
    assert os.path.exists(filename)
...
def test_family_status_group_predefined(fixture_dirname):
    filename = fixture_dirname("pedigrees/pedigree_phenos.ped")
    assert os.path.exists(filename)
...
def test_family_sex_group_predefined(fixture_dirname):
    filename = fixture_dirname("pedigrees/pedigree_phenos.ped")
    assert os.path.exists(filename)
...
def test_family_sizes_group_predefined(fixture_dirname):
    filename = fixture_dirname("pedigrees/pedigree_phenos_B.ped")
    assert os.path.exists(filename)
