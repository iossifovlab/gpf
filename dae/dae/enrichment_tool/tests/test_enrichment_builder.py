...
#  test that even with only enabled + selected_background_models, the tool works
def test_study_with_custom_config(create_test_study: Callable[[dict], GenotypeData],
