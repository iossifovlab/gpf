...
def test_get_selected_counting_models_missing_field(
    create_test_study: Callable[[dict], GenotypeData],
) -> None:
    study_config = {
        "enrichment": {
...
def test_get_selected_counting_models_missing_field_and_counting(
    create_test_study: Callable[[dict], GenotypeData],
) -> None:
    study_config = {
        "enrichment": {
...
def test_get_default_background_model_missing_field(
    create_test_study: Callable[[dict], GenotypeData],
) -> None:
    study_config = {
        "enrichment": {
...
def test_get_selected_person_set_collections_missing_field(
    create_test_study: Callable[[dict], GenotypeData],
) -> None:
    study_config = {
        "enrichment": {
