...
def test_get_selected_counting_models_1(
...
def test_get_selected_counting_models_2(
    create_test_study: Callable[[dict], GenotypeData],
) -> None:
    study_config = {
        "enrichment": {
...
def test_get_selected_counting_models_3(
    create_test_study: Callable[[dict], GenotypeData]
) -> None:
    study_config = {
        "enrichment": {
...
def test_get_default_background_model_1(
    create_test_study: Callable[[dict], GenotypeData],
) -> None:
    study_config = {
        "enrichment": {
...
def test_get_selected_person_set_collections_1(
    create_test_study: Callable[[dict], GenotypeData],
) -> None:
    study_config = {
        "enrichment": {
