...
def test_dataset_rename_hdfs_directory(
    ...
    mocker.patch(
        "dae.impala_storage.helpers.hdfs_helpers.HdfsHelpers.rename",
        mock_rename)
...
def test_dataset_delete_hdfs_directory(
    ...
    mocker.patch(
        "dae.impala_storage.helpers.hdfs_helpers.HdfsHelpers.delete",
        mock_delete)
...
def test_dataset_recreate_impala_tables(
    ...
    mocker.patch(
        "dae.impala_storage.helpers."
        "impala_helpers.ImpalaHelpers.recreate_table",
        mock_recreate)
...
def test_dataset_drop_impala_tables(
    ...
    mocker.patch(
        "dae.impala_storage.helpers."
        "impala_helpers.ImpalaHelpers.drop_table",
        mock_drop)
...
def test_rename_study_config(fixtures_gpf_instance, mocker):
    ...
    mocker.patch("dae.impala_storage.schema1.import_commons.open", mock_open)
