...
def test_get_all_descriptions(
    denovo_gene_sets_db: DenovoGeneSetsDb,
) -> None:
...
def test_get_denovo_gene_sets_f4_autism(
    denovo_gene_sets_db: DenovoGeneSetsDb,
) -> None:
...
def test_get_denovo_gene_sets_f4_unaffected(
    denovo_gene_sets_db: DenovoGeneSetsDb,
) -> None:
    dgs = denovo_gene_sets_db.get_all_gene_sets(
...
def test_all_denovo_gene_set_ids(
    ...
    assert set(denovo_gene_sets_db.get_genotype_data_ids()) == {
