...
class ImpalaGenotypeStorage(GenotypeStorage):
    ...
    def study_tables(study_config):
        if (
            study_config.tables
            and study_config.tables.pedigree
            and study_config.tables.variant
        ):
    ...
    def simple_study_import(
        self, study_id, families_loader=None, variant_loaders=None, output="."
    ):
    ...
    def impala_load_study(self, study_id, variant_paths=[], pedigree_paths=[]):
        ...
        print(
            ...
            f"pedigrees from {pedigree_paths}",
            file=sys.stderr,
        )
        start = time()
