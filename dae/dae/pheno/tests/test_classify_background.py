...
def test_fake_background_classify(fake_background_df):
    ...
    for col in columns[1:]:
        ...
        assert measure_type == MeasureType.text or \
            measure_type == MeasureType.raw or \
...
def test_fake_background_build(test_config,
                               fake_ped_file,
                               fake_background_filename):
    ...
    instrument_df = prep.load_instrument('background',
                                         [fake_background_filename])
