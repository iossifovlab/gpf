...
def test_pheno_factory_simple(fake_pheno_db: PhenoDb) -> None:
    assert fake_pheno_db.config is not None


def test_check_pheno_db(fake_pheno_db: PhenoDb) -> None:
    assert fake_pheno_db.has_phenotype_data("fake")


def test_get_pheno_db(fake_pheno_db: PhenoDb) -> None:
...
def test_get_pheno_db_names(fake_pheno_db: PhenoDb) -> None:
