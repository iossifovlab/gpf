...
setuptools.setup(
    ...
    gene_set_collection=dae.gene_sets.gene_sets_db:build_gene_set_collection_implementation_from_resource
    gene_set=dae.gene_sets.gene_sets_db:build_gene_set_collection_implementation_from_resource
