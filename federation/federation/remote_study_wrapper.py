...
class RemoteWDAEStudy(WDAEAbstractStudy):
    ...
    def query_variants_preview_wdae(
        ...
        *,
        ...
        handle_genomic_scores(self.rest_client, kwargs)
...
def handle_gene_sets(rest_client: RESTClient, kwargs: dict[str, Any]) -> None:
